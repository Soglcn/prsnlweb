    ...
    return (
        <main className="projectPage">
            ...
            <div className="base">
                ...
                <img className="headImg" src="/images/projects/fitx.png" alt="" />
                ...
                <div className="usedTechs">
                    ...
                    <div className="uTech">
                        <div className="techLabel"> Swift </div>
                        <div className="techLabel"> SQL-Lite </div>
                        <div className="techLabel"> After Effects </div>
