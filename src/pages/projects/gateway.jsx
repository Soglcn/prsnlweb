    ...
    return (
        <main className="projectPage">
            ...
            <div className="base">
                ...
                <img className="headImg" src="/images/projects/gateway.png" alt="" />
                ...
                <div className="usedTechs">
                    ...
                    <div className="uTech">
                        <div className="techLabel"> OpenGL </div>
                        <div className="techLabel"> ESP-32 </div>
                        <div className="techLabel"> IMU </div>
