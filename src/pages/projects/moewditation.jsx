...
import pt from "./meowditation.json";
    ...
    return (
        <main className="projectPage">
            ...
            <div className="base">
                ...
                <img className="headImg" src="/images/projects/meowditation.png" alt="" />
                ...
                <div className="usedTechs">
                    ...
                    <div className="uTech">
                        <div className="techLabel"> Flutter </div>
                        <div className="techLabel"> Illustrator </div>
                        <div className="techLabel"> SQLLite </div>
                        <div className="techLabel"> Cubase </div>
